							...
							<div class="row">
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Profiles</h2>
											<!--<p class="text-small">
												To add users, you need to be signed in as the super user.
											</p>-->
											<p class="links cl-effect-1">
												<a href="<?php echo base_url('user/new_profile');?>">
													view more
												</a>
											</p>
										</div>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> 
											<i class="fa fa-shopping-cart fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Tags</h2>
											<!--<p class="text-small">
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> 
											<i class="fa fa-hand-o-up fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Tips</h2>
											<!--<p class="text-small">
												Store, modify, and extract information from your database.
											</p>-->
											<p class="links cl-effect-1">
												<a href="<?php echo base_url('home/tips');?>">
													view more
												</a>
											</p>
										</div>
									...
									<div class="panel panel-white no-radius">
										...
										<div class="panel-body no-padding">
											<div class="padding-10">
												<img width="50" height="50" src="./source/assets/dummy/avatar-1.jpg" class="img-circle pull-left" alt="">
													...
													<div id="users_followers" class="tab-pane padding-bottom-5 active">
														<div class="panel-scroll height-200">
															<table class="table no-margin">
																<tbody>
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="./source/assets/dummy/avatar-1-small.jpg"></td>
																	...
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="./source/assets/dummy/avatar-2-small.jpg"></td>
																	...
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="./source/assets/dummy/avatar-3-small.jpg"></td>
																	...
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="./source/assets/dummy/avatar-5-small.jpg"></td>
																	...
																	<tr>
																		<td class="center"><img alt="image" class="img-circle" src="./source/assets/dummy/avatar-4-small.jpg"></td>
												...
												<ol class="discussion">
													...
													<li class="self">
														...
														<div class="message">
															...
															<div class="message-avatar">
																<img src="./source/assets/dummy/avatar-1.jpg" alt="">
															</div>
														</div>
													</li>
													<li class="other">
														<div class="message">
															...
															<div class="message-avatar">
																<img src="./source/assets/dummy/avatar-2.jpg" alt="">
															</div>
														</div>
													</li>
													<li class="self">
...
<script>
		...
		var ios;
		var web;
		function getCount(date,phType,count){
			var ret;
			$.ajax({
				url:"<?php echo base_url('home/charts');?>",
				async:false,
				type:'POST',
				data:{dates:date,phone:phType,count:count},
	   ...
	   ios = getCount('2015-05-02','iPhone OS','10');
	   web = getCount('2015-05-02','Website','10');
	   //alert(responses);
		var data = {
			labels: xaxis,
			datasets: [{
