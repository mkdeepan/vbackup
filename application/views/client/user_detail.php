									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="clip-radio radio-primary">
												<input type="radio" value="1" name="gender" id="us-female" <?php if(isset($account[0]['accountGender']) && $account[0]['accountGender'] == '2') echo 'checked="checked"'; ?>>
												<label for="us-female">
													Female
												</label>
												<input type="radio" value="2" name="gender" id="us-male" <?php if(isset($account[0]['accountGender']) && $account[0]['accountGender'] == '1') echo 'checked="checked"'; ?>>
												<label for="us-male">
													Male
												</label>
					...
					<div id="panel_profile" class="tab-pane fade">
						<table class="table" id="profile">
							<thead>
								<tr>
									<th>S.No</th>
									<th class="hidden-xs">Profile Name</th>
									<th>Allergic To</th>
									<th class="hidden-xs">Emergency Contact #</th>
									<th class="hidden-xs center">More..</th>
								</tr>
							</thead>
							<tbody>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<span class="input-icon">
												<input type="text" readonly placeholder="User Name" class="form-control" name="username" id="username" value="<?php echo @$account[0]['accountEmail'];?>">
<i class="fa fa-user"></i>
										...
										<div class="form-group">
											...
											<span class="input-icon">
											<input type="password" placeholder="New password" class="form-control" name="new_pwd" id="new_pwd" autocomplete="off">
<i class="fa fa-unlock-alt"></i>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<span class="input-icon">
											<input type="password" placeholder="Old Password" class="form-control" id="old_pwd" name="old_pwd" value="">
<i class="fa fa-lock"></i>
										...
										<div class="form-group">
											...
											<span class="input-icon">
											<input type="password"  placeholder="Confirm password" class="form-control" id="c_pwd" name="c_pwd">
<i class="fa fa-unlock-alt"></i>
										    </span>
										</div> 
...
function checkForError()
   {
   	...
   	$('.phone').each(function(){
   	   var cur_obj = $(this);
	 	   ...
	 	   var msg = '';
    		val = cur_obj.val();
    		if(val != '' && val.replace(/[^0-9]/g,"").length > 15)
    		{
    			error = 1;
