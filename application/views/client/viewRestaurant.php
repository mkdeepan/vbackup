...
<div class="<?php echo ($this->session->userdata('isLogin'))?'container-fluid container-fullw bg-white':'box-login';?>">
	<div class="row">
		...
		<label></label>
		<p align="justify">
		By submitting feedback you agree that Vebinary Solutions, its affiliates, and any parties authorized may use, commercialize or reproduce the feedback without restriction or compensation to you.
		</p>
		</div>
